...
[Documentation](https://docs.rs/conjure-types)

`conjure-types` is the runtime support library that the types generated by `conjure-codegen` depend on. It reexports
