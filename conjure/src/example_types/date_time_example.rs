...
impl DateTimeExample {
    ...
    #[inline]
    pub fn datetime(&self) -> crate::DateTime<crate::Utc> {
        self.datetime
    }
}
#[derive(Debug, Clone, Default)]
pub struct Builder {
    datetime: Option<crate::DateTime<crate::Utc>>,
}
impl Builder {
    #[inline]
    pub fn datetime(&mut self, datetime: crate::DateTime<crate::Utc>) -> &mut Self {
